...
import { Layout, Carousel, Button, Row, Col, Icon } from 'antd';
            ...
            <Layout className="layout" >
                ...
                <Layout>
                    <div style={{ width: '65vw', margin: '100px auto' }}>
                        <p>Check out our newest courses</p>
                        <Row gutter={{ md: 24 }} style={{ textAlign: 'center' }}>
                        ...
                        <Row gutter={{ md: 24 }}>
                            <Col xs={{ span: 12 }} lg={{ span: 8 }}>
                                <div className='testimonials' style={{ textAlign: 'center' }}>
                                    <PandaIcon style={{ fontSize: '100px' }} />
